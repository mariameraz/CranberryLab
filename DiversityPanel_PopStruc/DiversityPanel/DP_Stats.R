...
setwd('~/Documents/DiversityPanel_PopStruc/DiversityPanel/DP_VCF_stats/')

# QUALITY per site
#-------
# Load the quality info
var.qual <- read_delim('DP_vcf.lqual', delim = '\t')
...
#---------------------
# Variant mean depth
var.depth <- read_delim('DP_vcf.ldepth.mean', delim = '\t')
head(var.depth)
...
# Missing data 
#-------------------
var_miss <- read_delim("DP_vcf.lmiss", delim = "\t")
summary(var_miss)
...
# MAF
#------------------
var_freq <- read_delim("DP_vcf.frq", delim = "\t",
...
ind_depth <- read_delim("DP_vcf.idepth", delim = "\t",
...
# NAs per ind 
#----------
ind_miss  <- read_delim("DP_vcf.imiss", delim = "\t",
...
ind_het <- read_delim("DP_vcf.het", delim = "\t",
